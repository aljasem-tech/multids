...
- Optional dependency extras, a support matrix, compatibility policy, opt-in
  real-service integration checks, and benchmark helpers.

### Changed

- Aligned local and S3 object operations, added cursor-pagination helpers, and
  introduced consistent connector lifecycles.
- Added OpenSearch retry/backoff, structured retry logs, and typed errors.
- Made backend dependencies optional and updated documentation examples and CI
  validation.
